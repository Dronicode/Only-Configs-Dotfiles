...
mkdir -p "$HOME/.config/nvim/tools/vale/styles/Custom"
mkdir -p "$HOME/.config/nvim/tools/vale/styles/config/vocabularies/dictionaries"
safe_link "$CONFIGS_DIR/nvim/tools/vale/.vale.ini" "$HOME/.config/nvim/tools/vale/.vale.ini"
safe_link "$CONFIGS_DIR/nvim/tools/vale/styles/Custom/Spelling.yml" "$HOME/.config/nvim/tools/vale/styles/Custom/Spelling.yml"
touch "$HOME/.config/nvim/tools/vale/styles/config/vocabularies/dictionaries/accept.txt"
touch "$HOME/.config/nvim/tools/vale/styles/config/vocabularies/dictionaries/reject.txt"
"$SCRIPT_DIR/sync-vale-packages.sh" "$HOME/.config/nvim/tools/vale/.vale.ini"
echo "✓ Linked and synched Vale LSP"


echo "✓ Core symlinks created"